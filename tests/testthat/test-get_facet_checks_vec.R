test_that("get_facet_checks_vec() factor", {

    # test factor (5 levels)
    test_facet <- get_facet_checks_vec(x =
...
test_that("get_facet_checks_vec() ordered", {
  # test ordered factor (5 levels)
  ord_test <- get_facet_checks_vec(x =
...
test_that("get_facet_checks_vec() character", {

    # test character (5 unique values)
    chr_test <- get_facet_checks_vec(x =
