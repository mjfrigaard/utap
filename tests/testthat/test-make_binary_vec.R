test_that("make_binary_vec() logical works", {
  ...
  # test logical
  expect_equal(object = select(binary_vec_test, where(is.logical)) |>
...
test_that("make_binary_vec() integer works", {
  binary_vec_test <- readRDS(testthat::test_path("fixtures", "binary_vec_test.rds"))
  # test integer
  expect_equal(object = select(binary_vec_test, where(is.integer)) |>
                        make_binary_vec(type = "log"),
...
test_that("make_binary_vec() character works", {
  binary_vec_test <- readRDS(testthat::test_path("fixtures", "binary_vec_test.rds"))
  # test character
  expect_equal(object = select(binary_vec_test, where(is.character)) |>
